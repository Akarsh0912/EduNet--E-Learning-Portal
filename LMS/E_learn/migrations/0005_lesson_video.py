# Generated by Django 4.2.6 on 2024-03-06 08:25
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('E_learn', '0004_what_you_learn_requirements'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='E_learn.course')),
                ('lesson', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='E_learn.lesson')),
            ],
        ),
    ]
